...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DraftTindakan.ascx.cs" Inherits="I_ACT.Pages.DraftTindakan" %>
    ...
    <div class="col-md-12 animatedParent animateOnce z-index-50">
        <div class="breadcrumbBack">
                   <ol class="breadcrumb breadcrumb-2">
                    ...
                    <li class="active"><strong>Draft</strong></li>
                    </ol>
        </div>
    </div>
</div>
                                    ...
                                    <asp:TemplateColumn SortExpression="NoNotulenDetail" HeaderStyle-Width="15%" HeaderText="Reg. Number" HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="20px">
                                        <ItemTemplate>
                                            <div style="margin-left: 2px;overflow:hidden;text-overflow:ellipsis;">
                                                <asp:Label runat="server" ID="lblNoNotulenDetail" Text='<%#Eval("NoNotulenDetail") %>'></asp:Label>
                                            </div>
                                        </ItemTemplate>
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList runat="server" ID="ddlSumber" CssClass="form-control dropdownlist ddlSumber">
                                </asp:DropDownList>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6 animatedParent animateOnce ">
                                        <div class="form-group">
                                            ...
                                            <asp:Label runat="server" ID="edit_lblNoNotulenDetail" Visible="false"></asp:Label>
                                            <asp:Label runat="server" ID="edit_lblNomer" Visible="false"></asp:Label>
                                            ...
                                            <table border="1" title="A risk matrix is a matrix that is used during risk assessment to define the level of risk by considering the category of probability or likelihood against the category of consequence severity. This is a simple mechanism to increase visibility of risks and assist management decision making">
                                                <tbody>
                                                    <tr style="height: 21px;">
                                                        <th style="width: 25%; height: 63px; text-align: center; vertical-align: middle;" colspan="3" rowspan="3">RAM</th>
                                                        <th style="height: 40px; text-align: center;" colspan="5">Severity</th>
                                                    </tr>
                                                    <tr>
                                                        <th class="tableHead">Insignificant</th>
                                                        <th class="tableHead">Minor</th>
                                                        <th class="tableHead">Moderate</th>
                                                        <th class="tableHead">Significant</th>
                                                        <th class="tableHead">Catastrophic</th>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr style="height: 21px;">
                                                        <th style="transform: rotate(-90deg); width: 5%; height: 0px; text-align: center; vertical-align: middle;" rowspan="5" scope="col">Probability</th>
                                                    ...
                                                    <tr style="height: 21px;">
                                                        <th  class="tableHead">Possible</th>
                                                        <th  class="tableHead">3</th>
...
<input class="form-control txProbability" id="txProbability" runat="server" type="text" disabled="disabled" style="width:80% !important;display:none; float:right">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 animatedParent animateOnce ">
                                        <div class="form-group" style="padding-top: 13%">
                                            <button type="button" visible="false" class="btn btn-success form-control" id="btnUpdateRekekomendasi" runat="server" onclick="validateDetail();" onserverclick="btnUpdateRekekomendasi_ServerClick">Update Recommendation</button>
                                        ...
                                        <div class="table-responsive" style="margin-bottom: 17px;">
                                            <asp:DataGrid ID="dgAddRekomendasi" CssClass="GridBox" runat="server"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundColumn DataField="Nomer" Visible="false" HeaderText="ID Kompetensi" HeaderStyle-HorizontalAlign="Left" />
                                                    ...
                                                    <asp:TemplateColumn>
                                                        ...
                                                        <ItemTemplate>
                                                            <div style="margin-left: 6px">
                                                                 <asp:LinkButton  ID="dgAddKompetensi_btnEdit" CssClass="btn btn-warning btn-xs" runat="server" ToolTip="Edit Rekomendasi" CommandName="Edit" CommandArgument='<%#Eval("NoNotulenDetail")+ ";" + Eval("Nomer") %>'><i class="fa fa-pencil fa-lg"></i></asp:LinkButton>
                    ...
                    <div class="panel-footer" style="text-align:right;">
                        ...
                        <button type="button" class="btn btn-primary" id="btnSave" validationgroup="btnSave" runat="server" onclick="validateHead();" onserverclick="btnSave_ServerClick">Save i</button>
                        ...
                        <button type="button" class="btn btn-primary" id="btnUpdate" runat="server" onclick="validateHead();" onserverclick="btnUpdate_ServerClick">Submit</button>
